...
Anyone can open a **pull request** to suggest edits to documents in our repositories:  
**https://github.com/swissgenomicsassociation**

Pull requests are the **recommended way to contribute**. In some cases, core contributors may also be **added directly to the GitHub organisation**.
